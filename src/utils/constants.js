// Mapeo de nombres de países en inglés (del GeoJSON) a español
...
export const materialesMoneda = ['Oro', 'Plata', 'Bronce', 'Cobre', 'Níquel', 'Aluminio', 'Bimetálica', 'Otro'];

export const estadosConservacion = ['Excelente', 'Muy Bueno', 'Bueno', 'Regular', 'Malo'];
